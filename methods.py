...
centroid_to_main_near_table = arcpy.GenerateNearTable_analysis(taxlot_centroid, config.mains_copy, r"in_memory/centroid_to_main_near_table", '#', "LOCATION", "NO_ANGLE", "CLOSEST")
